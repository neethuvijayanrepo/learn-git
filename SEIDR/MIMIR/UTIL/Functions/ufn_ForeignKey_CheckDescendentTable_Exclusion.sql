...
CREATE FUNCTION [UTIL].[ufn_ForeignKey_CheckDescendentTable_Exclusion]
(	
...
BEGIN
	...
	AND @ExcludingID NOT IN (REFERENCED_OBJECT_ID, PARENT_OBJECT_ID)
	...
	BEGIN
		...
		AND @ExcludingID NOT IN (fk.REFERENCED_OBJECT_ID, fk.PARENT_OBJECT_ID)
