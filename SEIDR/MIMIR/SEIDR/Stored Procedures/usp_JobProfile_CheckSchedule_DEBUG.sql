CREATE PROCEDURE [SEIDR].[usp_JobProfile_CheckSchedule_DEBUG]
...
BEGIN
	...
	*/ 
	...
	AND (@JobProfileID is null OR jp.JobProfileID = @JobProfileID)
	...
	AND (@JobProfileID is null OR js.JobProfileID = @JobProfileID)
