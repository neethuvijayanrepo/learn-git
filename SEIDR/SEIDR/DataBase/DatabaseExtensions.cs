...
namespace SEIDR.DataBase
{
    ...
    public static class DatabaseExtensions
    {
            ...
            foreach(DataColumn col in dcc)
            {
                ...
                if(properties.TryGetValue(col.ColumnName, out p) )
                {
                    ...
                    else
                    {
                        ...
                        {
                            Type drvType = nValue.GetType();
                            if (drvType != underType) //Attempt changeType conversion
                            {
                                nValue = Convert.ChangeType(nValue, underType);
                            }
                        }
                        /*else
                        {
        ...
        public static DataTable ToTable<RT>(this RT o, params string[] ignoredProperties)
        {
            return o.ToTable(null, ignoredProperties);
        }
        public static DataTable ToTable<RT>(this RT o, string TableName, params string[] ignoredProperties)
        {
            var l = new[] { o };
            return (l.AsEnumerable()).ToTable(TableName, ignoredProperties);
        }
        public static DataTable ToTable<RT> (this IEnumerable<RT> o, params string[] ignoredProperties) 
        {
            return o.ToTable(null, ignoredProperties);
        }        
        public static DataTable ToTable<RT>(this IEnumerable<RT> o, string TableName, params string[] ignoredProperties)
        {
