...
namespace SEIDR
{
    ...
    public class Mailer
    {
        ...
        public void SendMail(string subject, string MailBody, bool isHtml = true, 
            ...
            System.Collections.Generic.IEnumerable<MailAddress> MultiRecipient = null,
            ...
            MailPriority mailPriority = MailPriority.Normal)
        {
            ...
            if (MultiRecipient == null && string.IsNullOrWhiteSpace(SendTo) && string.IsNullOrWhiteSpace(RecipientList))
                throw new System.ArgumentNullException(nameof(RecipientList));
            ...
            //If MultiRecipient specified as well, separately, just add directly to 'To' first
            if(MultiRecipient != null)
            {
                MultiRecipient.ForEach(r => mail.To.Add(r));
            }            
            else if (SendTo != null && RecipientList == null)
            {
                mail.To.Add(SendTo);
            }
            if (mail.To.Count == 0)
                return; //No Mail target.
